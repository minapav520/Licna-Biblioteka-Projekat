            ...
            <div class="row align-items-center">
                <div class="col-md-9">
                    ...
                    <h3 style="font-style: italic; margin-bottom: 5px;">
                        ...
                        <?php if($book->is_favorite): ?> <span style="color: var(--orange);">❤️</span> <?php endif; ?>
                    </h3>
                ...
                <div class="col-md-3 text-end">
                    ...
                    <form action="<?php echo e(route('books.destroy', $book)); ?>" method="POST" class="d-inline">
                        ...
                        <button class="btn btn-sm btn-outline-danger px-3" onclick="return confirm('Obriši?')">
                            Obriši
                        </button>
                    </form>
                </div>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Mina🌷\Akademija\Zimski semestar\Veb1\Projekat\eBiblioteka\resources\views/books/index.blade.php ENDPATH**/ ?>