...
<div class="card-custom" style="max-width: 600px; margin: auto;">
    ...
    <form method="post" action="<?php echo e(route('books.store')); ?>">
        ...
        <div class="row">
            ...
            <div class="col"><label>Stranica</label><input type="number" name="pages" class="form-control"></div> 
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Mina🌷\Akademija\Zimski semestar\Veb1\Projekat\eBiblioteka\resources\views/books/create.blade.php ENDPATH**/ ?>