...
<body>
    <nav>
        <a href="{{ url('/') }}" class="logo">PersoLib</a>
        <div class="nav-links">
            <a href="{{ url('/') }}">Početna</a>
            <a href="{{ route('books.index') }}">Moja Polica</a>
            <a href="{{ route('books.index', ['favorites' => 1]) }}" style="color: var(--orange);">❤️ Omiljeno</a>
            <a href="{{ route('books.create') }}" class="btn-main">Nova Knjiga</a>
        </div>
    </nav>
